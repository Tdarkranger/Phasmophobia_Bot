...
SaveAllPhotos("E:\Steam\steamapps\common\Phasmophobia", "C:\Users\Cliente\Desktop\Phasmophobia_Bot\Pictures")
;AVAILABLE HOTKEYS
F1::AddAverage()
F2::CopyPhotos("E:\Steam\steamapps\common\Phasmophobia", "C:\Users\Cliente\Desktop\Phasmophobia_Bot\Pictures")
...
SaveAllPhotos(path_from, path_to) {
	...
	Loop, 
	{
		...
		ImageSearch, FoundX, FoundY, 0, 0, A_ScreenWidth, A_ScreenHeight, *50 C:\Users\Cliente\Desktop\Phasmophobia_Bot\References\Payment.jpg
		if (FoundX != "" and FoundY != "")
		{
			...
			ImageSearch, FoundX, FoundY, 0, 0, A_ScreenWidth, A_ScreenHeight, *50 C:\Users\Cliente\Desktop\Phasmophobia_Bot\References\Experience.jpg
			if (FoundX != "" and FoundY != "")
			{
				;CLICKS ON SECOND RESUME
				mouseclick, left, % A_ScreenWidth/2, % FoundY + 600
				;UPDATES MATCH (REFERENCE IS LAST MATCH)
				FileRead, reference, C:\Users\Cliente\Desktop\Phasmophobia_Bot\System\Reference.txt
				reference += 1
				FileDelete, C:\Users\Cliente\Desktop\Phasmophobia_Bot\System\Reference.txt
				FileAppend, % reference, C:\Users\Cliente\Desktop\Phasmophobia_Bot\System\Reference.txt
			}
		}
